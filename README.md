...
```
 เนื้อหาหลักสูตรสำหรับแนะนำหลักการ ตลอดการใช้งาน virtual machine เพื่อใช้ในทดสอบระบบงาน จำลองระบบงานต่างๆ ในการพัฒนาองค์ความรู้
 ก่อนทำในระบบจริงได้ โดยใช้ Oracle Virtual Box และ VmWare Workstation 
```
